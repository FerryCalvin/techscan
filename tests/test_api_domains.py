...
def test_api_domain_detail_diff(mock_get_conn, monkeypatch, tmp_path):
    ...
    rows = [
        [
            ...
            45,
            [
                {"name": "X", "version": "2", "categories": ["Cat"]},
                {"name": "Y", "version": None, "categories": ["Cat2"]},
            ],
            {"phases": {"engine_ms": 500}},
        ],
        [
            99,
            "fast",
            ...
            0,
            45,
            [{"name": "X", "version": "1", "categories": ["Cat"]}],
            {"phases": {"engine_ms": 400}},
        ],
    ]
