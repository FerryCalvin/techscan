...
if PROMETHEUS_AVAILABLE:
    ...
    TECH_COUNT = Gauge("techscan_technologies_detected", "Number of technologies detected in last scan", ["domain"])

    # Active scans gauge
    ACTIVE_SCANS = Gauge("techscan_active_scans", "Number of currently running scans")
    ...
    # Database metrics
    DB_CONNECTIONS = Gauge("techscan_db_connections_active", "Number of active database connections")
