...
STATS: Dict[str, Any] = {
    ...
    "scans": 0,
    "cache_entries": 0,
    "errors": {"timeout": 0, "dns": 0, "connection": 0, "generic": 0},
    "durations": {
        "fast": {"count": 0, "total": 0.0},
        "full": {"count": 0, "total": 0.0},
        "fast_full": {"count": 0, "total": 0.0},
    },
    "recent_samples": {"fast": deque(maxlen=50), "full": deque(maxlen=50), "fast_full": deque(maxlen=50)},
    ...
    "single_flight": {"active_keys": 0, "locked": 0, "inflight": 0},
}
