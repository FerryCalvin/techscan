...
class FeatureExtractor:
    ...
    def __init__(self):
        self.framework_patterns = {
            name: [re.compile(p, re.I) for p in patterns] for name, patterns in FRAMEWORK_PATTERNS.items()
        }
        self.server_patterns = {name: re.compile(pattern, re.I) for name, pattern in SERVER_PATTERNS.items()}
    ...
    def _extract_header_features(self, headers: Dict[str, str]) -> Dict[str, Any]:
        ...
        features = {
            ...
            "has_security_headers": (
                ...
                or "content-security-policy" in headers_lower
    ...
    def _extract_pattern_features(self, html: str) -> Dict[str, Any]:
        ...
        for framework, patterns in self.framework_patterns.items():
            match_count = sum(len(pattern.findall(html_lower)) for pattern in patterns)
